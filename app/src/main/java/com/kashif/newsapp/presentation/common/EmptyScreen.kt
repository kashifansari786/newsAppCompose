...
import com.kashif.newsapp.presentation.Dimens.AnimIconSize
...
fun EmptyScreen(error:LoadState.Error?=null){
    ...
    val alphaAnimation by animateFloatAsState(targetValue = if (startAnimation) 0.3f else 0f,
...
fun EmptyContent(alphaAnim:Float,message:String,iconId:Int){
    Column(modifier = Modifier.fillMaxSize(),
        ...
        Text(text = message,
            ...
            modifier = Modifier.padding(Elevation).alpha(alphaAnim))
